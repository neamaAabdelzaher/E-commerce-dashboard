            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-6">
                        ...
                        <input type="text" name="name_ar" value="{{old('name_ar')}}" class="@error('name_ar') is-invalid @enderror form-control" id="name_ar">
                    @error('name_ar')
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="name_en"  value="{{old('name_en')}}" class=" @error('name_en') is-invalid @enderror form-control" id="name_en">
                        @error('name_en')
                    <div class="alert alert-danger mt-1">
                        {{$message}}
                    </div>
                ...
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <input type="text" name="code"  value="{{old('code')}}" class="@error('code') is-invalid @enderror form-control" id="code">
                        @error('code')
                    <div class="alert alert-danger mt-1">
                        {{$message}}
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-4">
                        ...
                        <option disabled selected > Select subCategory</option>
                            ...
                            <option value="{{$subCategory->id}}" {{ $subCategory->id == old('sub_category_id') ? 'selected':''  }}> {{$subCategory->sub_cat_name}}</option>
                            @endforeach
                        </select>
